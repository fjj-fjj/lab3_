...
void
proc_freekpagetable(pagetable_t pg)
{
  ...
  //uvmunmap(pg,(uint64)etext,(PHYSTOP-(uint64)etext)/PGSIZE,0);
...
scheduler(void)
{
  ...
  for(;;){
	...
	//printf("ssssschedular\n");
	sfence_vma();
	//printf("sccccccheduler\n");
